...
@pytest.mark.parametrize(
    ...
    [
        ...
        "examples/10_streaming_replay.py",
        "examples/11_sensitive_fields.py",
        "examples/12_dry_run_confirmation.py",
        "examples/13_async_workflow.py",
        "examples/14_revalidate_recording.py",
    ],
)
